Crie uma lista lista_1 dos inteiros de 6 a 20 (ambos inclusos) utilizando range;
Imprima o último elemento da lista_1;
Altere o segundo elemento de lista_1 para 'Kenzie'. Imprima lista_1;
Utilize do fatiamento para imprimir somente os elementos de índice 2, 3 e 4 de lista_1;
...
Crie e imprima uma nova lista ordenada inversamente (lista_2) com base em lista_1, sem ordenar de fato a lista_1. Imprima lista_1 e lista_2;
